...
export class RoleController {
    ...
    getAll = async (req: Request, res: Response) => {
        ...
        const get_all_roles = new GetAllRolesUseCase(this.role_repository);

        logger.info("Trying to get roles");
        const {error, roles} = await get_all_roles.execute(get_all_roles_options);
    ...
    getById = async (req: Request, res: Response) => {
        ...
        const get_role_by_id = new GetRoleByIdUseCase(this.role_repository);

        logger.info("Trying to get the role details");
        const {error, role} = await get_role_by_id.execute(role_id);
    ...
    create = async (req: Request, res: Response) => {
        ...
        const create_role_usecase = new CreateRoleUseCase(this.role_repository);
    ...
    updateById = async (req: Request, res: Response) => {
        ...
        const update_role_by_id = new UpdateRoleByIdUseCase(this.role_repository);

        logger.info(`Trying to update the role`);
        const {error, isUpdated} = await update_role_by_id.execute(role_id, req.body);
    ...
    deleteById = async (req: Request, res: Response) => {
        ...
        const delete_role_by_id = new DeleteRoleByIdUseCase(this.role_repository);
    ...
    getUsersByRoleId = async (req: Request, res: Response) => {
        ...
        const get_users_by_role_id = new GetUsersByRoleIdUseCase(this.role_repository);

        logger.info(`Trying to get the users from the role`);
        const {error, users} = await get_users_by_role_id.execute(role_id);
